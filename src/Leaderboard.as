namespace Leaderboard {
    ...
    bool byGameMode() {
        ...
        return false
            or mode.StartsWith("TM_Archivist_")
            or validModes.Find(mode) > -1
        ;
    }
    ...
    bool byManiaLink() {
        ...
        if (false
            or CMAP.Playground is null
            or CMAP.UILayers.Length < 2
        ) {
            return false;
        }
        ...
        for (uint i = 0; i < CMAP.UILayers.Length; i++) {
            ...
            if (false
                or start == -1
                or end == -1
                or !Layer.ManialinkPageUtf8.SubStr(start, end).Contains("UIModule_Race_Record")
            ) {
                continue;
            }
            ...
            auto Button = cast<CGameManialinkQuad>(Layer.LocalPage.GetFirstChild("quad-toggle-records-icon"));
    ...
    bool byPersonalBest() {
        ...
        const uint pb = CMAP.ScoreMgr.Map_GetRecord_v2(
            CMAP.UserMgr.Users[0].Id,
    ...
    bool byStartTime() {
        ...
        return false
            or PlaygroundScript is null
            or PlaygroundScript.StartTime <= 2147483000
        ;
    }
